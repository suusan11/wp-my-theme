<?php
  function _themename_sidebar_widgets()
  {
      ...
      'description' => esc_html__("This sidebar appears in the blog posts page.", '_themaname'),
      'before_widget' => '<section id="%1$s" class="c-sidebar-widget u-marign-bottom-20 %2$s">',
...
foreach ($columns as $i => $column) {
    register_sidebar(array(
      ...
      'description' => esc_html__("Footer Widgets", '_themaname'),
